  ...
  const categories = [
    {
      ...
      icon: '🇲🇾',
      bannerImage: '/assets/admin/hero-malay.jpg',
      bgColor: '#1a472a',
      accentColor: '#d4af37'
    },
    {
      ...
      icon: '🇨🇳',
      bannerImage: '/assets/admin/hero-chinese.jpg',
      bgColor: '#b01e23',
      accentColor: '#ffd700'
    },
    {
      ...
      icon: '🇯🇵',
      bannerImage: '/assets/admin/hero-japanese.jpg',
      bgColor: '#111111',
      accentColor: '#e83e8c'
    },
    {
      ...
      icon: '🥩',
      bannerImage: '/assets/admin/hero-western.jpg',
      bgColor: '#2b3e50',
      accentColor: '#3498db'
    },
    {
      ...
      icon: '🍛',
      bannerImage: '/assets/admin/hero-indian.jpg',
      bgColor: '#a35d00',
      accentColor: '#e67e22'
    }
  ];
